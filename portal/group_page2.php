...
.prop-item .pro-prop {margin-right: 10px;margin-top: 10px; flex:1;}
</style>
 ...
 <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <!-- Title -->
     <a href="property_unit.php"><img style="background-color: rgb(255, 255, 255);" src="img/realitindia_logo.png"></a>
