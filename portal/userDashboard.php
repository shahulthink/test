...
<div class="container-fulid">
 ...
 <img src="http://bbkgeojit.com/images/properties-banner.jpg" alt="" style="width: 100%;height: 40vh;">
    ...
    <div class="col-md-6"></div>
      <div class="col-md-2">
          ...
          <div style="width: 50%;" class="profile-userpic">
            ...
            <div class="profile-usertitle" style="float:left;">
    ...
    <li><b>45</b> <p>Friends</p></li>
    <li><b>55</b><p>Follower</p> </li>
    <li><b>4</b><p>Reviews</p> </li>
    <li><b>Join</b><p>Groups</p> </li>
    <li><b>4</b><p>Shortlist</p> </li>
...
<div class="container-fuild listing">
  ...
  <div class="col-md-9">
    ...
    <h4 style="margin-left: 10px">Trending Properties</h4>
      <div class="col-md-4">
           <div class="card">
                <a href="unitsheader.php"><div class="card-image">
